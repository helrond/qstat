...
config(['$routeProvider', function($routeProvider) {
  ...
  $routeProvider.when('/games/:gameId', {templateUrl: 'partials/games/detail.html', controller: 'gameDetailCtrl'});
  ...
  $routeProvider.when('/players/:playerId', {templateUrl: 'partials/players/detail.html', controller: 'playerDetailCtrl'});
